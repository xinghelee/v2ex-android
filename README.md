...
- **加密 DNS**：可选 DoH 解析（自动 / Cloudflare / Google / 阿里 / DNSPod / Quad9 / 自定义地址），每条线路可测试延迟；默认关闭，线路不通自动回退系统 DNS；答案默认 IPv4 优先，可切换为 IPv6 优先
...
- **通知**：回复 / @ / 感谢分类，官网账号级未读角标与“全部已读”同步，点通知直达对应帖子；可选**新提醒推送**（WorkManager 定时轮询，15 / 30 / 60 分钟，默认关，点系统通知直达通知页）
...
- 新提醒推送依赖系统定时任务，最短 15 分钟；部分国产系统会限制后台，需允许自启动并关闭电池优化
